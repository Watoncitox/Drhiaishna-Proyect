...
export default function ProductosCRUD() {
  ...
  return (
    <>
      <NavbarAdmin />
      <div className="container mt-5 pt-5 productos-crud-page">
            ...
            {productos.map((p) => (
              <tr key={p.id}>
                ...
                <td className="text-end">
                  ...
                  <Button size="sm" variant="outline-danger" onClick={() => eliminar(p.id)}>
                    Eliminar
                  </Button>
                </td>
              </tr>
      ...
      <Modal show={show} onHide={() => setShow(false)}>
        <Modal.Header closeButton>
          <Modal.Title>{form.id ? "Editar producto" : "Nuevo producto"}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
